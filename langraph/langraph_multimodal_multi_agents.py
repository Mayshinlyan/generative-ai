...
def load_image(question:str, imagepath: str):
    ...
    messages = [HumanMessage(content=[
                {"type": "text", "text": f"Here is the {question}. Also explain your reasoning"},
...
def load_audio(question:str, filepath: str):
    ...
    # Create a message
    messages = [HumanMessage(content=[
                {"type": "text", "text": f"Here is the {question}."},
...
def supervisor_node(state: State) -> Command[Literal[*members, "__end__"]]:
    ...
    # Ensure each agent is only call once
    if goto in completed_agents:
